        ...
        <div class="content">
            <div class="assessment-form">
                <form action="/assess" method="POST" class="form-assess">
                    ...
                    <input type="hidden" name="moduleid" readonly value="Module 3">
                    
                    @foreach (\App\Models\Assessment::select('questions')->where('module', 'Module 3')->get() as $question)
                ...
                @if ((\App\Models\Assessment::select('questions')->where('module', 'Module 3')->first()) == null)
