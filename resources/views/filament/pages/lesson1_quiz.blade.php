        ...
        <div class="content">
            <div class="assessment-form">
                <form action="/assess" method="POST" class="form-assess">
                    ...
                    <input type="hidden" name="moduleid" readonly value="Module 1">
                    
                    @foreach (\App\Models\Assessment::select('questions')->where('module', 'Module 1')->get() as $question)
                ...
                @if ((\App\Models\Assessment::select('questions')->where('module', 'Module 1')->first()) == null)
